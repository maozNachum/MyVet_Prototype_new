...
declare namespace VinextRouteTypes {
  type PageRoute = "/";
  type LayoutRoute = "/";
  type RouteHandlerRoute = "/api/activity" | "/api/archive" | "/api/calendar" | "/api/export" | "/api/notifications" | "/api/projects" | "/api/saved-views" | "/api/tasks" | "/api/templates";
  type AppRoute = "/" | "/api/activity" | "/api/archive" | "/api/calendar" | "/api/export" | "/api/notifications" | "/api/projects" | "/api/saved-views" | "/api/tasks" | "/api/templates";
