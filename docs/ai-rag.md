...
> **הערת תחזוקה 31.08.2026:** הארכיטקטורה והגבלות ההרשאה תקפות כמדריך. סטטוסי Preview/Production במסמך הוחלפו בראיות Staging המאוחרות; RAG עדיין אינו נחשב מאושר Production ללא שערי ה־Runbook.
