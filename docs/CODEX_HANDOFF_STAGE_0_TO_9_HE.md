...
> **מסמך היסטורי של תוכנית ה־AI, נכון ל־17.07.2026.** הוא אינו מקור אמת למצב הסביבות, המיגרציות או מספר הבדיקות הנוכחי. לחפיפה עדכנית ראו `CODEX_PARTNER_FULL_SYSTEM_HANDOFF_HE.md`.
