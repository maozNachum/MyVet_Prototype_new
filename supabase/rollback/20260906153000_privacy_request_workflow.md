...
approval. The management RPC is limited to an authenticated, active clinic
administrator in the matching clinic and does not delete customer, medical,
Storage, AI, billing, audit, or backup data.
