...
declare
  ...
  trusted_clinic_admin_bootstrap boolean :=
    tg_table_schema = 'public'
    and tg_table_name = 'staff'
    and tg_op = 'INSERT'
    ...
    and not exists (
      select 1 from public.staff as existing_staff
      where existing_staff.clinic_id = target_clinic_id
    );
begin
